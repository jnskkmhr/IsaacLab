...
T1_MINIMAL_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        # usd_path="source/isaaclab_assets/isaaclab_assets/robots/USD/t1_29dof_corrected.usd",
        # usd_path="source/isaaclab_assets/isaaclab_assets/robots/USD/t1_29dof_no_upper_collision.usd",
        # usd_path="source/isaaclab_assets/isaaclab_assets/robots/USD/T1_visual.usd",
        # usd_path="source/isaaclab_assets/isaaclab_assets/robots/USD/t1_reimport/t1_29dof_feet_hand/t1_29dof_feet_hand.usd",
        # usd_path=f"{ISAACLAB_ASSETS_DATA_DIR}/booster/t1_29dof_no_upper_collision_aug28.usd", 
        usd_path=f"{ISAACLAB_ASSETS_DATA_DIR}/booster/t1_29dof_corrected.usd", 
        # usd_path=f"{ISAACLAB_ASSETS_DATA_DIR}/booster/t1_29dof_corrected_no_upper_collision.usd", 
