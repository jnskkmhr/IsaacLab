...
from isaaclab_tasks.core.cartpole import agents as cartpole_agents
from isaaclab_tasks.contrib.velocity.config.anymal_c import agents as anymal_c_agents
...
gym.register(
    ...
    kwargs={
        ...
        "rl_games_cfg_entry_point": f"{cartpole_agents.__name__}:rl_games_manager_ppo_cfg.yaml",
        ...
        "skrl_cfg_entry_point": f"{cartpole_agents.__name__}:skrl_manager_ppo_cfg.yaml",
