...
class BlindLocomotionMPCAction(ActionTerm):
    ...
    cfg: actions_cfg.BlindLocomotionMPCActionCfg
    ...
    def __init__(self, cfg: actions_cfg.BlindLocomotionMPCActionCfg, env: ManagerBasedEnv):
    ...
    def process_actions(self, actions: torch.Tensor):
        ...
        for i in range(self.num_envs):
            ...
            self.mpc_controller[i].set_command(
                gait_num=self.cfg.gait_num, #1:standing, 2:walking
...
#     cfg: actions_cfg.PerceptiveLocomotionMPCActionCfg
#     """The configuration of the action term."""
#     _asset: Articulation
#     """The articulation asset on which the action term is applied."""
#     _scale: torch.Tensor
...
#     def __init__(self, cfg: actions_cfg.PerceptiveLocomotionMPCActionCfg, env: ManagerBasedEnv):
#         # initialize the action term
#         super().__init__(cfg, env)
