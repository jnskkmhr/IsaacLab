...
gym.register(
    id="Isaac-Velocity-Soft-Legacy-Rough-T1-v0",
...
gym.register(
    id="Isaac-Velocity-Soft-Legacy-Rough-T1-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Isaac-Velocity-Soft-Legacy-Flat-T1-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Isaac-Velocity-Soft-Legacy-Flat-T1-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
