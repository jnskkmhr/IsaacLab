...
class CriticCfg(ObsGroup):
    ...
    base_com_xyz_offset = ObsTerm(
        func=t1_mdp.base_com_xyz_offset,
        params={
            "asset_cfg": SceneEntityCfg(
                "robot",
                body_names=["Trunk"]
    ...
    base_height = ObsTerm(func=t1_mdp.base_height)  # TODO: compensate for terrain height for rough terrain.
