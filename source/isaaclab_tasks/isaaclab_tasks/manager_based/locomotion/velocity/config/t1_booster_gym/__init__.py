...
gym.register(
    id="Isaac-Velocity-Rough-T1-Booster-Gym-v0",
...
gym.register(
    id="Isaac-Velocity-Rough-T1-Booster-Gym-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Isaac-Velocity-Flat-T1-Booster-Gym-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Isaac-Velocity-Flat-T1-Booster-Gym-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
