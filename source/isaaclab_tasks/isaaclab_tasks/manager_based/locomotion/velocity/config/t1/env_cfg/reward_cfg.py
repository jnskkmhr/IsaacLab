...
class T1RewardsCfg(RewardsCfg):
    ...
    #     func=t1_mdp.base_height_exp, # type: ignore
    #     weight=0.5,
    #     params={
    #         "target_height": 0.68,
    #         "std": 0.5
    ...
    action_rate_l2 = RewTerm(func=mdp.action_rate_l2, weight=-1) # type: ignore
    ...
    # sine_reference = RewTerm(
    #     func=t1_mdp.reward_sine_reference,
    #     weight=0.5,
    #     params={
    #         "ref_angle": 0.5,
