...
class T1ActionsCfg:
    ...
    #         "Left_Hip_Yaw": 0.5,
    #         "Left_Knee_Pitch": 0.5,
    #         "Left_Ankle_Pitch": 0.5,   # constrained ankle pitch
    #         "Left_Ankle_Roll": 0.5,   # constrained ankle roll
    #         "Right_Hip_Pitch": 0.5,
    #         "Right_Hip_Roll": 0.5,
    #         "Right_Hip_Yaw": 0.5,
    #         "Right_Knee_Pitch": 0.5,
    #         "Right_Ankle_Pitch": 0.5,   # constrained ankle pitch
    #         "Right_Ankle_Roll": 0.5,   # constrained ankle roll
    #     },
    #     offset={
    #         "Waist": 0.0,
    #         "Left_Hip_Pitch": -0.2,
